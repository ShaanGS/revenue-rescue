              ...
              <CardContent className="grid p-0 lg:grid-cols-[1.35fr_.9fr]">
                ...
                <div className="bg-stone-50 p-5">
                  ...
                  <ol className="mt-4 space-y-3">
                    {(log.length ? log : ["Awaiting agent investigation"]).map(
                      (x, i) => (
                  ...
                  {reasoning ? (
                    <>
                      ...
                      <p className="border-t pt-2 text-xs text-stone-500">
                        Rejected: {reasoning.rejected_alternatives.join(" · ")}
                      </p>
                    </>
                  ) : (
                    <div className="rounded-md border border-dashed border-stone-300 p-4 text-sm text-stone-500">
                      Run the agent to generate an evidence-backed proposal. No
                      scripted fallback is shown.
                    </div>
                  )}
                </CardContent>
              </Card>
              ...
              <Card className="border-red-200 bg-red-50">
                <CardContent className="p-5">
                  ...
                  <p className="mt-1 text-sm text-stone-600">
                    {agentError}. RevenueRescue will not replace a missing model
                    result with a scripted plan.
                  </p>
                </CardContent>
              </Card>
            )}
